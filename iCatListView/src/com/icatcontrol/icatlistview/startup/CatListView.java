...
public class CatListView extends PullToRefreshAdapterViewBase<SwipeMenuListView> {
	...
	public CatListView(Context context, Mode mode) {
		super(context, mode);
	}

	public CatListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(CatListView.this, deltaX, scrollX,
	...
	protected class InternalListView extends SwipeMenuListView implements
		...
		public void setEmptyView(View emptyView) {
			CatListView.this.setEmptyView(emptyView);
		}
