package com.icatcontrol.icatlistview.startup;
...
import com.icatcontrol.icatlistview.internal.*;
import com.icatcontrol.icatlistview.pulltorefresh.*;
import com.icatcontrol.icatlistview.*;

public class CopyOfCatListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public CopyOfCatListView(Context context) {
		super(context);

	}

	public CopyOfCatListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CopyOfCatListView(Context context, Mode mode) {
		super(context, mode);
	}

	public CopyOfCatListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(CopyOfCatListView.this, deltaX, scrollX,
	...
	protected class InternalListView extends ListView implements
		...
		public void setEmptyView(View emptyView) {
			CopyOfCatListView.this.setEmptyView(emptyView);
		}
